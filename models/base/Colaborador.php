 ...
 *
 * @property int $col_codcolaborador
 * @property int $col_codusuario
 * @property int $col_codunidade
 * @property int $col_coddepartamento
 * @property int $col_codcargo
 * @property int $col_codsituacao
 *
